      ...
      <div className="Audio_box">
        <section id="" className="linkBreak audio-wrapper">
          ...
          <div className="audio-left">
            {isPlay ?
               <img id="audioPlayer" onClick={() => this.audioPlay()} className="play-pause" alt="" src="https://img.wx168e.com/upload/images/firstnews/2019/07/31/144634661.png" />
              :<img id="audioPlayer" onClick={() => this.audioPlay()} className="play-pause" alt="" src="https://img.wx168e.com/upload/images/firstnews/2019/08/01/200512349.png" />
            }
          </div>
