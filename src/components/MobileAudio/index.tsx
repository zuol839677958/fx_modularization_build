...
class Audio extends Component<any, AudioState, IAudioProps> {
    ...
    constructor(props: IAudioProps) {
        super(props);
        this.state = {
            url: "https://file.wbp5.com/upload/files/2020/08/04/030128915042.mp3", //地址
            current: "00:00", //当前时间
        ...
        return (
            <div className="Audio_box">
                <section id="" className="linkBreak audio-wrapper">
                    <audio ref={this.audio} src={url} controls preload="auto"></audio>
